...
public class UpdateFlightStatusDto {
    ...
    public UpdateFlightStatusDto(Long id, String statusi, LocalDateTime dataNisjes, LocalDateTime dataArritjes, String aeroportiNisjes, String aeroportiArritjes) {
        this.id = id;
